...
contract MeetScheduler is Ownable {
    uint256 public meetFee;
    ...
    constructor(uint256 _meetFee) Ownable(msg.sender) {
        meetFee = _meetFee;
    }

    function payForCourse(string memory email) public payable {
        require(msg.value == meetFee, "Payment must be equal to the Meet fee");
